...
public class ArcVisualizer : MonoBehaviour {
	...
	public ParabolicRaycaster arcRaycaster;
	...
	OVRInput.Controller Controller {
		get {
			...
			if ((controllers & OVRInput.Controller.LHand) == OVRInput.Controller.LHand) {
				return OVRInput.Controller.LHand;
			}
			if ((controllers & OVRInput.Controller.RHand) == OVRInput.Controller.RHand) {
