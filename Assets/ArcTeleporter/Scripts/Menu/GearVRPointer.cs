...
public class GearVRPointer : MonoBehaviour {
	...
	public OVRInput.Controller Controller {
		get {
			...
			if ((controller & OVRInput.Controller.LHand) != OVRInput.Controller.None) {
				return OVRInput.Controller.LHand;
			} else if ((controller & OVRInput.Controller.RHand) != OVRInput.Controller.None) {
	...
	public Transform ControllerTransform {
		get {
			...
			} else if (controller == OVRInput.Controller.RHand) {
